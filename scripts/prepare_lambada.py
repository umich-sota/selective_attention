...
def prepare(
    destination_path: Path = Path("data/lambada"),
    checkpoint_dir: Path = Path("checkpoints/stabilityai/stablelm-base-alpha-3b"),
    seed: int = 42,
    test_size: Union[float, int, None] = 0.05,
) -> None:
    ...
    dataset = load_dataset("lambada", num_proc=num_proc_load_dataset)
    ...
    for split, dset in tokenized.items():
        ...
        # total_batch = 1024 or maxmium sample number
